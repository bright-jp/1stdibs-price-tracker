...
Info  : https://brightdata.jp/products/insights/price-tracker/1stdibs
"""
...
# https://brightdata.jp/products/web-scraper/1stdibs
DATASET_ID = os.getenv("BRIGHTDATA_DATASET_ID", "")
if not DATASET_ID:
    raise EnvironmentError(
        "BRIGHTDATA_DATASET_ID is not set.\n"
        "1. Build your 1stDibs scraper at: https://brightdata.jp/products/web-scraper/1stdibs\n"
